...
public class WordLadder {
    public List<List<String>> findLadders(String beginWord, String endWord, Set<String> wordList) {
        ...
        if (!foundDestination) {
            ...
            setParent(parent, beginWord, new ArrayDeque<>(), endWord, result);
        }
        return result;
    }

    private void setParent(Map<String, List<String>> parent, String startWord, Deque<String> path, String currentWord, List<List<String>> result) {
